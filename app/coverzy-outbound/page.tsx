...
export default function CoverzyOutboundPage() {
  ...
  const startCall = async () => {
    try {
      ...
      await vapiRef.current?.start("dab754ab-b2ec-44f0-8bc6-b6c204d88eb0");
    } catch (error) {
  ...
  return (
    <>
      <Head>
        <title>Coverzy Outbound AI Demo | Caller.Digital</title>
        <meta name="description" content="Experience Coverzy Outbound AI demo with intelligent outbound calling and lead generation capabilities." />
      </Head>
      <main className="min-h-screen bg-gradient-to-br from-emerald-100 via-teal-100 to-cyan-100 relative overflow-hidden">
        <div className="relative z-10 min-h-screen flex flex-col items-center justify-center px-4 py-16">
          <div className="max-w-5xl w-full space-y-16">
            ...
            <div className="flex flex-col items-center text-center space-y-6">
              ...
              >
                Experience our advanced AI assistant with natural voice interaction capabilities. Start a conversation and see how Coverzy can help you with outbound calling and lead generation.
              </motion.p>
            </div>
              ...
              >
                {!isCallActive ? (
                  <button
                    ...
                    className="bg-gradient-to-r from-emerald-400 via-teal-500 to-cyan-500 text-white px-8 py-4 rounded-xl font-semibold text-lg shadow-lg hover:from-emerald-500 hover:to-cyan-600 transition-all duration-300 disabled:opacity-50 disabled:cursor-not-allowed"
                  >
