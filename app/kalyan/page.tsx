...
export default function KalyanPage() {
  ...
  const startCall = async () => {
    try {
      ...
      await vapiRef.current?.start("b816bb4a-8b9a-4230-b3b3-536f2b1bb1ab");
    } catch (error) {
  ...
  return (
    <>
      <Head>
        <title>Kalyan AI Assistant Demo | Caller.Digital</title>
        <meta name="description" content="Experience Kalyan AI assistant demo with voice interaction capabilities." />
      </Head>
        ...
        <div className="relative z-10 min-h-screen flex flex-col items-center justify-center px-4 py-16">
          <div className="max-w-5xl w-full space-y-16">
            ...
            <div className="flex flex-col items-center text-center space-y-6">
              ...
              >
                Experience our advanced AI assistant with natural voice interaction capabilities. Start a conversation and see how Kalyan can help you.
              </motion.p>
            </div>
