...
export default function RealEstateDemoPage() {
  ...
  const startCall = async () => {
    try {
      ...
      await vapiRef.current.start("1273a48a-8329-4b5a-a058-29b07d89cbc5");
    } catch (error) {
  ...
  return (
    <>
      <Head>
        <title>Real Estate AI Demo | Caller.Digital</title>
        <meta name="description" content="Experience Real Estate AI assistant demo with voice interaction capabilities for property inquiries and assistance." />
      </Head>
        ...
        <div className="relative z-10 min-h-screen flex flex-col items-center justify-center px-4 py-16">
          <div className="max-w-5xl w-full space-y-16">
            ...
            <div className="flex flex-col items-center text-center space-y-6">
              ...
              >
                Experience our Real Estate AI assistant with natural voice interaction capabilities. Get property information, schedule viewings, and more through intelligent conversation.
              </motion.p>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-10">
              ...
              >
                <h3 className="text-xl font-semibold text-gray-900 mb-6">Real Estate AI Features</h3>
                <ul className="space-y-4 text-gray-700 text-base">
                  <li>Property search assistance</li>
                  <li>Viewing schedule management</li>
                  <li>Market analysis and insights</li>
                  <li>Mortgage and financing info</li>
              ...
              >
                ...
                <ul className="space-y-4 text-gray-700 text-base">
                  ...
                  <li>Ask about properties, prices, or areas</li>
