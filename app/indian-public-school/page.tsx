...
export default function IndianPublicSchoolPage() {
  ...
  const startCall = async () => {
    try {
      ...
      await vapiRef.current?.start("fbf3a8fa-3fa7-4ff0-be3f-20bb7c059bd8");
    } catch (error) {
  ...
  return (
    <>
      <Head>
        <title>The Indian Public School AI Demo | Caller.Digital</title>
        <meta name="description" content="Experience The Indian Public School AI assistant demo with voice interaction capabilities." />
      </Head>
        ...
        <div className="relative z-10 min-h-screen flex flex-col items-center justify-center px-4 py-16">
          <div className="max-w-5xl w-full space-y-16">
            ...
            <div className="flex flex-col items-center text-center space-y-6">
              ...
              >
                The Indian Public School AI Demo
              </motion.h1>
              <motion.p 
              ...
              >
                Experience our educational AI assistant with natural voice interaction capabilities. Start a conversation and see how The Indian Public School AI can help you.
              </motion.p>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-10">
              ...
              >
                <h3 className="text-xl font-semibold text-gray-900 mb-6">Educational AI Features</h3>
