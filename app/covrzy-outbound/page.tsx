...
export default function CovrzyOutboundPage() {
  ...
  return (
    <>
      <Head>
        <title>Covrzy Outbound AI Demo | Caller.Digital</title>
        <meta name="description" content="Experience Covrzy outbound AI assistant demo with voice interaction capabilities." />
      </Head>
        ...
        <div className="relative z-10 min-h-screen flex flex-col items-center justify-center px-4 py-16">
          <div className="max-w-5xl w-full space-y-16">
            ...
            <div className="flex flex-col items-center text-center space-y-6">
              ...
              >
                Experience our outbound AI assistant with natural voice interaction capabilities. Start a conversation and see how Covrzy can help you.
              </motion.p>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-10">
              ...
              >
                <h3 className="text-xl font-semibold text-gray-900 mb-6">Outbound AI Features</h3>
