...
export default function HandpickdPage() {
  ...
  const startCall = async () => {
    try {
      ...
      await vapiRef.current?.start("1ecc9172-af45-4ab9-98f2-617bd9e8773e");
    } catch (error) {
  ...
  return (
    <>
      <Head>
        <title>Handpickd AI Demo | Caller.Digital</title>
        <meta name="description" content="Experience Handpickd AI assistant demo with voice interaction capabilities." />
      </Head>
        ...
        <div className="relative z-10 min-h-screen flex flex-col items-center justify-center px-4 py-16">
          <div className="max-w-5xl w-full space-y-16">
            ...
            <div className="flex flex-col items-center text-center space-y-6">
              ...
              >
                Experience our Handpickd AI assistant with natural voice interaction capabilities. Start a conversation and see how Handpickd can help you.
              </motion.p>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-10">
              ...
              >
                <h3 className="text-xl font-semibold text-gray-900 mb-6">Handpickd AI Features</h3>
                <ul className="space-y-4 text-gray-700 text-base">
                  <li>Curated selection assistance</li>
